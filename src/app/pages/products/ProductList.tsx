      ...
      <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-md shadow-xl max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-3">
          ...
          {[
            ...
            ["Updated", formatDate(product.updated)],
          ].map(([label, value]) => (
        ...
        <div className="flex gap-2 px-5 py-4 border-t border-slate-100 shrink-0">
          ...
          <button onClick={onEdit} className="flex-1 py-2 bg-blue-600 text-white rounded-lg text-xs hover:bg-blue-700 cursor-pointer">Edit Product</button>
        </div>
      </div>
    </div>
  );
            ...
            <div className="bg-slate-50 rounded-xl p-4 space-y-3">
              ...
              {form.category === "Bundle" && (
                <div>
                  ...
                  <button className="flex items-center gap-1.5 text-xs text-blue-600 hover:text-blue-700 cursor-pointer">
  ...
  return (
    ...
    <div>
      ...
      <FilterBar
        ...
        extraFilters={
          <>
            <FilterDropdown
              value={catFilter}
              onChange={(value) => { setCatFilter(value); setPage(1); }}
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        {filtered.length === 0 && <div className="text-center py-12 text-slate-400 text-sm">No products found</div>}
